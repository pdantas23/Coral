// ─── FloatingLines — ReactBits (adaptado para TypeScript) ────────────────────
// Fonte: github.com/DavidHDev/react-bits
...
export default function FloatingLines({
  ...
  const getCount = (wave: string) => {
    ...
    const idx = enabledWaves.indexOf(wave as any);
  ...
  useEffect(() => {
    ...
    const onLeave = () => { targetInfluenceRef.current = 0.0; };
  ...
  return (
    <div
      ref={containerRef}
      style={{ width: "100%", height: "100%", position: "relative", overflow: "hidden", mixBlendMode: mixBlendMode as any }}
    />
  );
}
